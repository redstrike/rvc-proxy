...
if(context.global.genstartenable===1) {
    if(context.global.genstartenabletimer<1) {
    ...
    countdown=context.global.genstartenabletimer;
    context.global.genstartenabletimer--;
